  ...
  <html>
    ...
    <body>
        ...
        <ul id="slide-out" class="side-nav">
          ...
          <li><a class="waves-effect waves-light" href="anggota.php"><i class="material-icons">account_box</i>Data Anggota</a></li>
          ...
          <div class="row">
            <div class="col l12 m12 s12">
              <div class="card-panel">
                <h5 class="text-darken-2 center">Tambahkan Anggota</h5>
              </div>
            </div>
          </div>
          <div class="row">
                ...
                <form class="col s12" action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="input-field col s6">
                      <input id="nis" type="text" name="nis" class="validate" required>
                  ...
                  <div class="row">
                    <div class="col s12">
                      <button class="btn right" type="submit" name="tambah">Tambahkan Anggota</button>
                    </div>
                  </div>
                </form>
              </div>
